#!/usr/bin/env python3
"""Evaluate a local LeRobot checkpoint through LeRobot's normal LIBERO evaluator.
...
def timed_make_policy(*args: Any, **kwargs: Any):
    """Record successful checkpoint loading and inference timing."""
    ...
    def timed_select_action(batch: dict[str, Any]):
        # Chunked policies compute a fresh action sequence only when their queue is empty.
